"""
TrendMate — Malaysian Fashion Seller Research Assistant
=======================================================
An AI-powered market research assistant for Malaysian online
fashion sellers on Shopee, Lazada, and TikTok Shop.
"""
...
def load_system_prompt():
    ...
    return "You are a market research assistant for Malaysian online fashion sellers."
...
TOOLS = [
    {
        "name": "search_web",
        "description": (
            "Search the web for Malaysian fashion market information. "
            "Use this to find trending products, competitor pricing, "
            "supplier options, platform updates, and seasonal opportunities "
            "for Malaysian online fashion sellers."
        ),
        "input_schema": {
            "type": "object",
            "properties": {
...
PRESET_QUESTIONS = [
    ...
    "How early should I stock up for Hari Raya and what styles sell best during that season?",
]

def show_menu():
    print()
    print("=" * 65)
    print("   TrendMate — Malaysian Fashion Seller Research Assistant")
    print("=" * 65)
    print()
